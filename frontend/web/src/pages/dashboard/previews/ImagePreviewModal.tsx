...
import { FileContentConflictError } from '../../../api/files'
...
export function ImagePreviewModal({
    ...
    onSaveText: (item: Item, text: string, options?: { force?: boolean }) => Promise<void>
}) {
    ...
    const saveEdit = useCallback(async ({ closeAfterSave = true, force = false }: { closeAfterSave?: boolean; force?: boolean } = {}) => {
        ...
        <div className="image-preview" role="presentation" onMouseDown={onClose}>
            ...
            >
                ...
                <div className="image-preview__stage">
                    ...
                    {preview.url && preview.kind === 'sheet' && (
                        <Suspense fallback={<PreviewFallback label="Loading spreadsheet preview..." />}>
                            <SheetPreview item={preview.item} url={preview.url} onDownload={onDownload} />
                        </Suspense>
                    )}
                    {preview.text !== null && (
                        isEditingText ? (
                            <TextFileEditor
                                ...
                                showConflictActions={hasConflict}
                            />
                        ) : (
                            <TextFilePreview
                                canHighlightPython={canHighlightPython}
